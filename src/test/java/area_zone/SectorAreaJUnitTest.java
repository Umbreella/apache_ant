...
public class SectorAreaJUnitTest {
    ...
    private SectorArea sectorArea = new SectorArea(area);
    private Point point;
    ...
    @Test
    public void test_When_XGreaterThan0_Should_ReturnFalse() {
        point.setX(1);
        point.setY(1);
        point.setR(10);
    ...
    @Test
    public void test_When_PowXAndYGreaterThanPowHalfR_Should_ReturnFalse() {
        point.setX(-1);
        point.setY(1);
        point.setR(1);
    ...
    @Test
    public void test_When_PowXAndYLessThanPowHalfR_Should_ReturnTrue() {
        point.setX(-1);
        point.setY(1);
        point.setR(10);
